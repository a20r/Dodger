...
def plot_noise_planner(planner, i):
    tb = table.load_csv("data/{}_speed_noise_{}.csv".format(planner, i))
    plt.figure()
    plot_noise_vs(tb, "mean_min_distance", "std_min_distance", "Meters [m]")
    ...
    plt.figure()
    plot_noise_vs(tb, "avg_times", "std_times", "Seconds [s]")
...
def plot_noise_std_planner(planner, i):
    tb = table.load_csv("data/{}_speed_noise_{}.csv".format(planner, i))
    plt.figure()
    plot_noise_std_vs(tb, "std_min_distance", "Meters [m]")
    ...
    plt.figure()
    plot_noise_std_vs(tb, "std_times", "Seconds [s]")
